// Shared mock UI examples + their icons, reused by the demo (App.tsx) and the
// standalone showcase page (Showcase.tsx). Kept presentational and class-driven
// so all styling lives in styles.css.
...
export function TaskCircleIcon() {
  return (
...
export function MockWorkingCard() {
  return (
...
export function MockSubscribeButton() {
  return (
